      ...
      <Tabs defaultValue="general" className="w-full">
        ...
        {/* Projetos */}
         <TabsContent value="projects" className="bg-white rounded-xl border border-gray-200 p-6 space-y-4">
           <div className="space-y-3">
             {form.project_statuses && form.project_statuses.length > 0 && form.project_statuses.map((status, idx) => (
        ...
        {/* Tarefas */}
         <TabsContent value="tasks" className="bg-white rounded-xl border border-gray-200 p-6 space-y-4">
           <div className="space-y-3">
             {form.task_statuses && form.task_statuses.length > 0 && form.task_statuses.map((status, idx) => (
